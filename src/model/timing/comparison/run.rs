...
pub struct Run {
    ...
    pub total_in_pb_run: Option<super::Time>,
    /// The sum of best segment times in the comparison.
    pub sum_of_best: Option<super::Time>,
}

impl Run {
    /// Iterates over all of the totals stored in this [Run].
    pub fn totals(&'_ self) -> impl Iterator<Item = (TotalType, Option<super::Time>)> + '_ {
